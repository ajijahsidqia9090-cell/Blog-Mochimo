...
if(empty($invoice) && ($metode == 'BANK' || $metode == 'QRIS')){
    ...
    mysqli_query($conn,"UPDATE pesanan SET nomor_pembayaran='$invoiceBaru' WHERE id_pesanan='$id_pesanan'");
    $invoice = $invoiceBaru;
}
...
<style>
body {
    background-color: #fff5f6; /* Latar belakang soft pink susu */
    font-family: 'Poppins', sans-serif;
    color: #4a4a4a;
}

/* Pinky Gradient Header Banner */
...
/* Garis hiasan alamat bercorak Pink-Biru Pastel */
...
/* Kotak Instruksi Pembayaran Pastel */
        ...
        <div class="card-body p-4">
            ...
            <div class="payment-instruction-box">
                <div class="row align-items-center">
                    <div class="col-md-7 border-end border-pink pr-4">
                        <div class="mb-3">
    ...
    <div class="card shopee-card">
        <div class="card-body p-4">
            ...
            <div class="mt-4 pt-2">
                ...
                <?php 
                // Logika Perbaikan: Menghitung ulang total secara dinamis agar selalu akurat
                $total_bayar_real = $total - $diskon;
                if($total_bayar_real < 0) $total_bayar_real = 0;
                ?>
                ...
                <div class="summary-row summary-total-row align-items-center">
                    ...
                    <div class="summary-value text-pink-primary fs-3 fw-bold">
                        Rp<?= number_format($total_bayar_real) ?>
                    </div>
                </div>
            </div>
        </div>
